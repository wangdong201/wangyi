<template>
  <div :class="{ dark: switchCheckStatus }">
    <div class="w-screen bg-[#F8F9FD] text-[#000] mt-0 overflow-hidden dark:bg-[#1A1A22] dark:text-[#fff]">
      <div class="w-[92.3vw] mx-auto bg-[#F8F9FD] overflow-hidden dark:bg-[#1A1A22]">
        <!-- 搜索栏 -->
        <div
        ...
        >
          ...
          <input
            type="text"
            placeholder="郁可唯"
            class="border rounded-[5vw] px-4 py-2 w-[72.2vw] h-[8.7vw] pl-[10vw] dark:bg-[#313138]"
          />
