<template>
  <div class="w-screen">
    <div class="fixed z-40 bg-[#597BA0] top-0 w-screen h-[7.358vw]">
      <div class="flex justify-between text-[#fff] w-[92.6vw] bg-[#597BA0] mx-auto">
    ...
    <div class="bg-[#597BA0]">
      <div class="w-[92.6vw] mx-auto">
        ...
        <span
          class="w-[5vw] h-[5vw] rounded-[50%] bg-[#908161] flex"
          style="align-items: center; justify-content: center; w"
          ><Icon icon="ep:arrow-up" 
          class="text-[#fff] text-[3.5vw]"
      ...
      <div class="bg-[#fff] rounded-[5vw] mt-[5vw]">
        <div class="w-[92.7vw] mx-auto">
          <div class="h-[10.2vw] flex items-center justify-between sticky">
            <div
            ...
            >
              ...
              <p class="whitespace-nowrap">({{ data.data?.songs?.length }})</p>
            </div>
